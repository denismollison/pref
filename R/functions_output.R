...
dec1=tx[[1]]; dec2=tx[[2]]
cex1=1.8*min(1,(20+10*nc)/nchar(dec1))
cex2=1.8*min(1,(30+5*nc)/nchar(dec2))
graphics::text(nc*2.5,vmax*1.3,dec1,cex=cex1)
graphics::text(nc*2.5,vmax*1.17,dec2,cex=cex2)
